class LeafSvg {
	...
	get noBase() {
		return {
			build: (stroke, fill, opacity, transformation) =>
				`<path vector-effect="non-scaling-stroke" d="M6.14,27.27c-1.76-8.88-4.71-13-4.71-13-4-7.62,6.44-9.9,6.44-9.9a3.55,3.55,0,0,0,2.68-2.44,3.55,3.55,0,0,0,2.67,2.44s10.49,2.28,6.44,9.9c0,0-2.94,4.13-4.71,13" transform="${transformation}" fill="${fill}" stroke="${stroke}" opacity="${opacity}" />`,
			w: 20.093,
			h: 25.349
		};
	}
